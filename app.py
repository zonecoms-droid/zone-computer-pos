        ...
        if selected_row['status'].startswith('COMPLETED'):
            ...
            if st.button("🖨️ สร้างเอกสารพร้อมพิมพ์อย่างเป็นทางการ", type="primary", key=f"gen_doc_{selected_job}"):
                ...
                <style>
                    ...
                    .print-btn-container {{ margin-bottom: 15px; display: flex; gap: 10px; justify-content: center; }}
                    .flow-container {{ background: white; border: 1px solid #cbd5e1; padding: 12mm 15mm; width: 190mm; height: 270mm; max-height: 270mm; box-sizing: border-box; box-shadow: 0 4px 15px rgba(0,0,0,0.08); display: flex; flex-direction: column; justify-content: space-between; position: relative; overflow: hidden; margin: 0 auto; }}
                    .content-wrap {{ position: relative; z-index: 1; }}
                    .header-tbl {{ width: 100%; border-collapse: collapse; }}
                    .cust-box {{ background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 10px 12px; margin: 10px 0; font-size: 12px; }}
                    .cust-box td {{ padding: 4px 6px; word-break: normal; overflow-wrap: break-word; }}
                    .items-tbl {{ width: 100%; border-collapse: collapse; margin-top: 8px; font-size: 12px; }}
                    .items-tbl th {{ background: {t_color}; color: white; padding: 8px 8px; text-align: left; font-weight: 600; }}
                    .items-tbl td {{ padding: 8px; border-bottom: 1px solid #e2e8f0; word-break: normal; overflow-wrap: break-word; }}
                    .summary-tbl {{ width: 100%; border-collapse: collapse; margin-top: 10px; font-size: 12px; }}
                    .summary-tbl td {{ padding: 5px 8px; }}
                    .footer-section {{ margin-top: auto; border-top: 1px solid #cbd5e1; padding-top: 12px; }}
                ...
                <body>
                    ...
                    <div class="flow-container">
                        ...
                        <div class="content-wrap">
                            ...
                            <table class="cust-box tbl">
                                <tr>
                                    <td style="width: 50%;"><b>ชื่อลูกค้า / บริษัท:</b> {tax_cust_name} ({tax_cust_branch})</td>
                            ...
                            <table style="width: 100%; margin-top: 10px;">
                                <tr>
                                    <td style="vertical-align: top; width: 55%; padding-top: 6px; font-size: 11px; color: #64748b; word-break: normal;">
                                ...
                                <div class="footer-box">
                                    <div style="width: 55%; margin: 0 auto;">
                                        <table style="width: 100%; text-align: center; font-size: 11px; border-collapse: collapse;">
                                            <tr>
                                                <td style="padding-bottom: 4px; width: 50%; line-height: 2.0;">
                                                    ลงชื่อ ......................................................<br>
                                                    ({l_sign})<br>
